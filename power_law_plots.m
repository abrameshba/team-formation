...
plot   '../dblp-'.year.'/'.network.'-expt-freq.txt' using 1:2 with point pointtype 3  pointsize 2 lc rgb "#0000FF" title "Number of experts"
#        f(x)  title "power law" lt 2 lw 1
reset
set terminal postscript eps enhanced color font 'Arial-Bold'
...
plot    '../dblp-'.year.'/'.network.'-skl-freq.txt' using 1:2 with point pointtype 3 pointsize 2 lc rgb "#0000FF" title "Number of skills"
