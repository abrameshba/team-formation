...
do for [network in  "vldb"] {
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:2 with linespoints title "DB - TPLClosest-1", \
...
#    set logscale y
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:3 with linespoints title "DB - TPLClosest-1", \
...
#    set logscale y
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:5 with linespoints title "DB - TPLClosest-1", \
...
#    set logscale y
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:6 with linespoints title "DB - TPLClosest-1",\
...
#    set logscale y
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:7 with linespoints title "DB - TPLClosest-1", \
...
#     set logscale y
    ...
    plot    '../dblp-'.year.'/db-170-0-tfs-results-vldb1.txt' using 1:8 with linespoints title "DB - TPLClosest-1", \
